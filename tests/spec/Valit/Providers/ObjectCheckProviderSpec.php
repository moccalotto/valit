...
class ObjectCheckProviderSpec extends ObjectBehavior
{
    ...
    function it_checks_objectOrClass()
    {
        ...
        $this->checkObjectOrClass(null)->shouldHaveType('Valit\Result\AssertionResult');
        ...
        $this->checkObjectOrClass('Valit\Result\AssertionResult')->success()->shouldBe(true);
    ...
    function it_checks_className()
    {
        ...
        $this->checkClassName(null)->shouldHaveType('Valit\Result\AssertionResult');

        $this->checkClassName(Exception::class)->success()->shouldBe(true);
        $this->checkClassName('SimpleXmlElement')->success()->shouldBe(true);
        $this->checkClassName('Valit\Result\AssertionResult')->success()->shouldBe(true);
    ...
    function it_checks_interfaceName()
    {
        ...
        $this->checkInterfaceName(null)->shouldHaveType('Valit\Result\AssertionResult');
        ...
        $this->checkInterfaceName('Valit\Result\AssertionResult')->success()->shouldBe(false);
    ...
    function it_checks_traitsName()
    {
        ...
        $this->checkTraitName(null)->shouldHaveType('Valit\Result\AssertionResult');
    ...
    {
        $this->checkInstanceOf(null, '')->shouldHaveType('Valit\Result\AssertionResult');
    ...
    {
        $this->checkImplements(null, 'Iterator')->shouldHaveType('Valit\Result\AssertionResult');
    ...
    {
        $this->checkHasMethod(null, '')->shouldHaveType('Valit\Result\AssertionResult');
