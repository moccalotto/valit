...
class UriCheckProviderSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Valit\Providers\UriCheckProvider');
    }
    ...
    function it_checks_hostname()
    {
        ...
        $this->checkHostname('foo.bar')->shouldHaveType('Valit\Result\AssertionResult');
    ...
    function it_checks_ip_address()
    {
        ...
        $this->checkIpAddress('127.0.0.1')->shouldHaveType('Valit\Result\AssertionResult');
    ...
    function it_checks_web_url()
    {
        ...
        $this->checkUrl('https://foo.bar')->shouldHaveType('Valit\Result\AssertionResult');
