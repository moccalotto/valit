...
class NoneOfSpec extends ObjectBehavior
{
    function it_is_initializable()
    {
        $this->beConstructedWith(Manager::instance(), ['isInt']);
        $this->shouldHaveType('Valit\Logic\NoneOf');
    }
    ...
    function it_will_only_accept_if_all_branches_fail()
    {
        ...
        $this->execute(true, 'XYZ')->success()->shouldBe(true);
        ...
        $this->execute(true, null)->success()->shouldBe(true);
        $this->execute(true, curl_init())->success()->shouldBe(true);
    }
}
