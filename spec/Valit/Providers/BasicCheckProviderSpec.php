...
class BasicCheckProviderSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('Valit\Providers\BasicCheckProvider');
    }
    ...
    {
        $this->checkIdenticalTo(null, null)->shouldHaveType('Valit\Result');
    ...
    {
        $this->checkIsOneOf('a', [])->shouldHaveType('Valit\Result');
    ...
    {
        $this->checkEquals(null, null)->shouldHaveType('Valit\Result');
    ...
    {
        $this->checkIsTruthy(null)->shouldHaveType('Valit\Result');
    ...
    {
        $this->checkIsFalsy(null)->shouldHaveType('Valit\Result');
    ...
    {
        $this->checkArray([])->shouldHaveType('Valit\Result');
